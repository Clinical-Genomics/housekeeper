...
class Bundle(Model):
    ...
    versions = orm.relationship('Version', backref='bundle', order_by='-Version.created_at', cascade='all')
...
class Version(Model):
    ...
    files = orm.relationship('File', backref='version', cascade='all')
...
class File(Model):
    ...
    tags = orm.relationship('Tag', secondary=file_tag_link, backref='files', cascade='all')
