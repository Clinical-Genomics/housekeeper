...
<<<<<<<< HEAD:tests/store/api/test_store_api.py
    bundle_old_obj, _ = store.create_bundle_and_version(data=bundle_data_old)
...
>>>>>>>> master:tests/store/handlers/test_readhandler.py
