...
class Helpers:
    ...
    @staticmethod
    def add_archive(store: Store, file_id: int, archive_task_id:int=1234) -> None:
        """Adds an archive object to the database."""
        new_archive: Archive = store.add_archive(
            file_id=file_id, archive_task_id=archive_task_id
        )
